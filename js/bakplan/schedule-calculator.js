...
export function generateBakplanSchedule(bakplanCategories, dayName = 'maandag', customCarts = null) {
    ...
    (bakplanCategories || []).forEach(catObj => {
        ...
        (catObj.items || []).forEach(prod => {
            ...
            const dayVals = (prod.days && prod.days[dayName]) ? prod.days[dayName] : prod;
