  ...
  dropdown.addEventListener("click", (e) => {
    ...
    if (isMulti) {
      ...
      optionEl.insertAdjacentHTML(
        "beforeend",
        '<span class="material-icons custom-select-check">check</span>',
      );
  ...
  return {
    ...
    setOptions: (newOptions, newSelectedValue = undefined) => {
      ...
      if (newSelectedValue !== undefined) {
        if (isMulti) {
          currentVal = Array.isArray(newSelectedValue)
            ? newSelectedValue.map(String)
            : newSelectedValue
          ...
          currentVal =
            newSelectedValue !== null && newSelectedValue !== undefined
              ? String(newSelectedValue)
              : "";
          hiddenVal.value = currentVal;
        }
